...
def application(environ, start_response):
    ...
    response_body = body % (
        environ.get('SERVER_NAME', default),  # Server Hostname or IP
        environ.get('SERVER_PORT', ),  # server port
        environ.get('REMOTE_ADDR', ),  # client IP
        environ.get('PATH_INFO', ),  # URI path
